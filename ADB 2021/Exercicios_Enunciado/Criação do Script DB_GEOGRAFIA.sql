...
CREATE TABLE TB_PAIS(
	...
	areasuperficie int NOT NULL,
	capital varchar(30) NOT NULL,
    PRIMARY KEY  (cod_pais)
 );
 
 CREATE TABLE TB_MOEDA(
	cod_moeda char(3) NOT NULL,
	descricao varchar(200) NOT NULL,
    PRIMARY KEY  (cod_moeda)
);

CREATE TABLE TB_MONTANHA(
	cod_montanha int auto_increment NOT NULL,
	montanha varchar(50) NOT NULL,
    PRIMARY KEY  (cod_montanha)
);

CREATE TABLE RL_MONTANHA_PAIS(
	cod_montanha int NOT NULL,
	cod_pais char(2) NOT NULL,
    PRIMARY KEY  (cod_montanha, cod_pais)
);

CREATE TABLE TB_PICO (
cod_pico int auto_increment NOT NULL,
nm_pico varchar (50) not null,
elevacao int NOT NULL,
cod_montanha int NOT NULL,
PRIMARY KEY  (cod_pico)
);

CREATE TABLE TB_RIOS (
cod_rio int auto_increment NOT NULL,
nm_rio varchar (50) NOT NULL,
comprimento int NOT NULL,
area_drenagem int NOT NULL,
descarga_media int NOT NULL,
fluxo_saida varchar (50) not null,
PRIMARY KEY  (cod_rio)
);



CREATE TABLE RL_PAIS_RIO(
	cod_rio int NOT NULL,
	cod_pais char(2) NOT NULL,
    PRIMARY KEY  (cod_rio, cod_pais)
);



ALTER TABLE TB_PAIS ADD FOREIGN KEY(cod_continente) REFERENCES TB_CONTINENTE (cod_continente);

ALTER TABLE TB_PAIS ADD FOREIGN KEY(cod_moeda) REFERENCES TB_MOEDA (cod_moeda);

ALTER TABLE RL_PAIS_RIO ADD FOREIGN KEY(cod_pais) REFERENCES TB_PAIS (cod_pais);

ALTER TABLE RL_PAIS_RIO ADD FOREIGN KEY(cod_rio) REFERENCES TB_RIOS (cod_rio);

ALTER TABLE RL_MONTANHA_PAIS ADD FOREIGN KEY(cod_pais) REFERENCES TB_PAIS (cod_pais);

ALTER TABLE RL_MONTANHA_PAIS ADD FOREIGN KEY(cod_montanha) REFERENCES TB_MONTANHA (cod_montanha);

ALTER TABLE TB_PICO ADD FOREIGN KEY(cod_montanha) REFERENCES TB_MONTANHA (cod_montanha);



INSERT INTO TB_CONTINENTE (cod_continente, nm_continente) VALUES
('AF', 'Africa'),
('AN', 'Antarctica'),
('AS', 'Asia'),
('EU', 'Europa'),
...
INSERT INTO TB_MOEDA (cod_moeda, descricao) VALUES
...
INSERT into TB_PAIS (cod_pais, iso_pais, nm_pais, cod_moeda, cod_continente, populacao, areasuperficie, capital) VALUES
...
('NF', 'NFK', 'Norfolk Island', 'AUD', 'OC', 1828, 34.6, 'Kingston'),
...
('VA', 'VAT', 'Vatican City', 'EUR', 'EU', 921, 0.44, 'Vatican'),
...
INSERT into TB_MONTANHA (cod_montanha, montanha) VALUES
(1, 'Alaska Range'),
(2, 'Alborz'),
(3, 'Andes'),
(4, 'Balkan Mountains'),
...
INSERT INTO RL_MONTANHA_PAIS (cod_montanha, cod_pais) VALUES
(1, 'US'),
(2, 'IR'),
(3, 'AR'),
(3, 'CL'),
...
INSERT INTO TB_PICO (cod_pico, nm_pico, elevacao, cod_montanha) VALUES
(62, 'Aconcagua', 6962, 3),
(63, 'Botev', 2376, 4),
...
INSERT INTO TB_RIOS (cod_rio, nm_rio, comprimento, area_drenagem, descarga_media, fluxo_saida) VALUES
...
INSERT INTO RL_PAIS_RIO (cod_rio, cod_pais) VALUES
(9, 'AO'),
(8, 'AR'),
(30, 'AT'),
(15, 'AU'),
